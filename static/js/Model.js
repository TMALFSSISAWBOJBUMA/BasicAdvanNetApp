...
Model.prototype.storeRFData = function (RFXML) {
  ...
  var numPorts = this.getXMLTagValue(
    RFXML,
    "/response/data/params/RF_PORT_NUMBER/result",
  )[0];
  var minPower = this.getXMLTagValue(
    RFXML,
    "/response/data/params/RF_POWER_MIN/result",
  )[0];
  var maxPower = this.getXMLTagValue(
    RFXML,
    "/response/data/params/RF_POWER_MAX/result",
  )[0];
  var readPower = this.getXMLTagValue(
    RFXML,
    "/response/data/params/RF_READ_POWER/result",
  )[0];
  var minSensitivity = this.getXMLTagValue(
    RFXML,
    "/response/data/params/RF_SENSITIVITY_MIN/result",
  )[0];
  var maxSensitivity = this.getXMLTagValue(
    RFXML,
    "/response/data/params/RF_SENSITIVITY_MAX/result",
  )[0];
  var sensitivity = this.getXMLTagValue(
    RFXML,
    "/response/data/params/RF_SENSITIVITY/result",
  )[0];
...
Model.prototype.storeReaderInfo = function (readerInfoXML) {
  //obtain all the values from the XML Document
  var code = this.getXMLTagValue(
    readerInfoXML,
    "/response/data/devices/device/code",
  )[0];
  var revision = this.getXMLTagValue(
    readerInfoXML,
    "/response/data/devices/device/revision",
  )[0];
  var family = this.getXMLTagValue(
    readerInfoXML,
    "/response/data/devices/device/family",
  )[0];
  var status = this.getXMLTagValue(
    readerInfoXML,
    "/response/data/devices/device/status",
  )[0];
...
Model.prototype.storeAntennas = function (antennasXML) {
  ...
  var antennas = this.getXMLTagValue(
    antennasXML,
    "/response/data/entries/entry/def",
  );
...
Model.prototype.getXMLTagValue = function (xml, xpath) {
  if (xml.evaluate) {
    ...
    if (node != null) {
      //node matched the xpath expression
      switch (node.resultType) {
        ...
        default:
          throw Error(
            "Error retrieving value from XML tag. The result type is unknown",
          );
      }
    }
...
Model.prototype.saveValues = function (values) {
  ...
  this.antennas = [];
  for (var a in values.antennas) this.setAntenna(values.antennas[a]);
...
/********* Setters *********/
Model.prototype.setMinPower = function (minPower) {
  this.minPower = minPower;
};
Model.prototype.setMaxPower = function (maxPower) {
  this.maxPower = maxPower;
};
Model.prototype.setNumPorts = function (numPorts) {
  this.numPorts = numPorts;
};
Model.prototype.setMinSensitivity = function (minSens) {
  this.minSensitivity = minSens;
};
Model.prototype.setMaxSensitivity = function (maxSens) {
  this.maxSensitivity = maxSens;
};
Model.prototype.setReadPower = function (readPower) {
  this.readPower = readPower;
};
Model.prototype.setWritePower = function (writePower) {
  this.writePower = writePower;
};
Model.prototype.setSensitivity = function (sens) {
  this.sensitivity = sens;
};
Model.prototype.setAntenna = function (antenna) {
  this.activeAntennas.push(antenna);
};
Model.prototype.setVolume = function (volume) {
  this.volume = volume;
};
Model.prototype.setCode = function (code) {
  this.code = code;
};
Model.prototype.setRevision = function (revision) {
  this.revision = revision;
};
Model.prototype.setFamily = function (family) {
  this.family = family;
};
...
Model.prototype.setReaderIP = function (readerIP) {
  this.readerIP = readerIP;
};

/********* Getters *********/
Model.prototype.getNumPorts = function () {
  return this.numPorts;
};
Model.prototype.getMinPower = function () {
  return this.minPower;
};
Model.prototype.getMaxPower = function () {
  return this.maxPower;
};
Model.prototype.getReadPower = function () {
  return this.readPower;
};
Model.prototype.getMinSensitivity = function () {
  return this.minSensitivity;
};
Model.prototype.getMaxSensitivity = function () {
  return this.maxSensitivity;
};
Model.prototype.getSensitivity = function () {
...
Model.prototype.getRevision = function () {
  return this.revision;
};
Model.prototype.getFamily = function () {
  return this.family;
};
Model.prototype.getActiveAntennas = function () {
  return this.activeAntennas;
};
...
Table.prototype.initHeaders = function () {
  var filterBoxes = document.querySelectorAll(
    "#tagsSection input[type=search]",
  );
...
*/
Table.prototype.addRowToTable = function (
  epc,
  antenna = 1,
  mux1 = 0,
  mux2 = 0,
  ...
  $(this.tableName).tabulator("updateOrAddRow", epc, {
    epc: epc,
    antenna: antenna,
    mux1: mux1,
    mux2: mux2,
...
Table.prototype.writeNumEPC = function () {
  ...
  document.getElementsByClassName("tabulator-col-title")[0].innerHTML =
    "EPC (" + numEPCs + ")";
};
